...
// =====================================================================
// 💡 PLC 스타일 데이터 영역
//   M: 비트 영역 - HMI %MX00010 <-> M[10] (10진수 직관 매핑)
//   D: 워드 영역 - HMI %DW10    <-> D[10]
//   R: 실수 영역 - HMI %RD0     <-> R[0] (Float 1:1 매핑)
// =====================================================================
extern bool* M;
extern uint16_t* D;
extern float* R;     // 🚀 인수인계서 준수: float 1:1
...
// =====================================================================
// 💡 미쓰비시 MC Protocol 메모리 영역 (A호환 1C 프레임)
//   X: 입력 비트 (16진수 주소 파싱)
//   Y: 출력 비트 (16진수 주소 파싱)
//   M: 내부 비트 (10진수 주소 파싱, 기존 Imodbus/Icnet과 공유 가능)
//   D: 데이터 워드 (10진수 주소 파싱, 기존 Imodbus/Icnet과 공유 가능)
// =====================================================================
extern bool* X;
extern bool* Y;

// =====================================================================
// 🚀 IMcProtocol (Mitsubishi MC Protocol Format 1) 명령어 세트
// =====================================================================
