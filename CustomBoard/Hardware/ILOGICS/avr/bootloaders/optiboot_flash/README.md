...
`make atmega128 AVR_FREQ=16000000L BAUD_RATE=115200 LED=E2 LED_START_FLASHES=2 UART=0`
`make atmega2560 AVR_FREQ=14745600L BAUD_RATE=115200 LED=B7 LED_START_FLASHES=2 UART=0`
